...
\begin{center}
	\begin{tikzpicture}
		...
		\node[align = center, draw, rounded corners=1.5mm, minimum width=3.5cm, minimum height=1.25cm, fill = purple!30,line width = 0.5mm] at (0,2) {\small \color{black}Input\\ \small \color{black}Embedding};
		...
		\node[align = center, draw, rounded corners=1.5mm, minimum width=3.5cm, minimum height=1.25cm, fill = purple!30,line width = 0.5mm] at (7,2) {\small \color{black}Input\\ \small \color{black}Embedding};
...
\begin{center}
	\begin{tikzpicture}[
		...
		\node[align = center] at (-2,2) {\small \textbf{Input}\\ \small \textbf{Embedding}};

		\node[align = center] at (-2,6) {\small \textbf{Positional}\\ \small \textbf{Encodings}};

		\node[align = center] at (-2,10) {\small \textbf{Positional}\\ \small \textbf{Input}\\ \small \textbf{Embeddings}};
	\end{tikzpicture}
\end{center}
...
\setcounter{chapter}{0}
	...
	\chapter{Các thành phần chính - bài toán của RL}
		...
		\begin{center}
			...
			\begin{tikzpicture}
				...
				\node[
						align=center, 
						text width=3cm, 
					] at (5,8) {\large\color{blue}\textbf{Agent}};
				...
				\node[
						...
						text width=4cm, 
						line width=0.5mm
					] at (5,5.5) {\color{blue}\textbf{Policy}};
				...
				\node[
						...
						text width=2.25cm, 
						line width=0.5mm
					] at (5,2.35) {\color{blue}\textbf{Learning Algorithm}};
				...
				\node[
						...
						text width=3cm, 
						line width=0.5mm
					] at (5,-4) {\color{blue}\textbf{Environment}};
				
				
				\node[
						align=center, 
						text width=3cm, 
					] at (-1,-3.5) {\color{blue}\textbf{State}};

				\node[
						align=center, 
						text width=3cm,
					] at (10,6) {\color{blue}\textbf{Action}};
				
				\node[
						align=center, 
						text width=3cm,
					] at (6,-0.5) {\color{blue}\textbf{Reward}};

				\node[
						align=center, 
						text width=3cm,
					] at (6.5,4) {\color{blue}\textbf{Policy update}};
